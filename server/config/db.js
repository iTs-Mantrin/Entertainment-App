...
const connectDB = async () => {
  try {
    ...
    const conn = await mongoose.connect("mongodb+srv://manishrajput62647457:UX3yJl1B7690pF8u@cluster0.iejs9r5.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0");
    //mongodb+srv://mpmanju9:cUMeVlG1AeDhiqoA@cluster0.xtasiys.mongodb.net/?retryWrites=true&w=majority
